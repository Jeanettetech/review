...
import static junit.framework.TestCase.assertEquals;
    ...
    public class MyAlgoBackTest extends AbstractAlgoBackTest {
        ...
        public void volumeImbalanceIndicator() throws Exception {
            ...
            String calculatedVolumeImbalanceIndication = algoLogic.calculateVolumeImbalance(state); // Capturing result of the calculation

            // then
            String expectedVolumeImbalanceIndication = "NEGATIVE(-0.33), POSSIBLE SELL PRESSURE";//remove
            assertEquals("Volume Imbalance calculation is", expectedVolumeImbalanceIndication, calculatedVolumeImbalanceIndication);
